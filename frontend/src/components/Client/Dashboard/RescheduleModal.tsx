...
interface RescheduleModalProps {
    onSubmit: (meetingDate: string, reason: string) => Promise<void>;
    onClose: () => void;
}

const RescheduleModal: React.FC<RescheduleModalProps> = ({ onSubmit, onClose }) => {
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            await onSubmit(formattedDate, reason);
        } catch (error) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <span style={{ fontSize: '13px', color: '#4b5563', lineHeight: '1.5' }}>
                Please set the new date and time for the official <strong>SK Session</strong> and provide a valid reason for this change.
            </span>
            ...
            <div style={{ marginTop: '10px' }}>
                <TextField
                    ...
                    placeholder="Provide a valid reason for why the meeting is being rescheduled..."
                    required
                />
            </div>
