...
import DisclosureExplorer from '../../../DigitalBulletin/DisclosureExplorer';
import DisclosureTopNavbar from '../../../DigitalBulletin/DisclosureTopNavbar';
import ProjectTemplateHeader from '../../Client/Projects/ProjectTemplateHeader';
import ProjectTemplateTable from '../../Client/Projects/ProjectTemplateTable';
import ProjectSheetTabs from '../../Client/Projects/ProjectSheetTabs';
import ProjectTableSkeleton from '../../Client/Projects/ProjectTableSkeleton';
import styles from '../../../DigitalBulletin/DisclosureDetailView.module.css';
...
const AdminProjectDetailView: React.FC = () => {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                // Use Admin endpoint
                const response = await axiosInstance.get(`/api/admin/project-list/${batchID}/details`);
    ...
    return (
        <div className={styles.container}>
            <DisclosureExplorer
                ...
                docEndpoint="/api/admin/project-list" // Point to Admin endpoint
            />

            <main className={styles.mainContent}>
                <DisclosureTopNavbar batchInfo={batchInfo} backPath="/admin/projects" />
