...
router.get('/all', authMiddleware, routeGuard.isAdmin, async (req, res) => {
  try {
    ...
    const roles = [
      ...
      { roleID: 2, roleName: 'SKC', description: 'SK Chairperson' },
      { roleID: 3, roleName: 'SKS', description: 'SK Secretary' },
      { roleID: 4, roleName: 'SKT', description: 'SK Treasurer' },
      { roleID: 5, roleName: 'SKK1', description: 'SK Kagawad 1' },
      { roleID: 6, roleName: 'SKK2', description: 'SK Kagawad 2' },
      { roleID: 7, roleName: 'SKK3', description: 'SK Kagawad 3' },
      { roleID: 8, roleName: 'SKK4', description: 'SK Kagawad 4' },
      { roleID: 9, roleName: 'SKK5', description: 'SK Kagawad 5' },
      { roleID: 10, roleName: 'SKK6', description: 'SK Kagawad 1' },
      { roleID: 11, roleName: 'SKK7', description: 'SK Kagawad 2' }
    ];
